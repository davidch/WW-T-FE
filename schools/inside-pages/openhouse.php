    ...
    <div class="row">
    	<div class="inner_padding">
	        <div class="span6 form_info">
	        	...
	        	<img src="../../../buildout/images/inside_pages/open-house1.jpg" alt="open house" />
	        	<img src="../../../buildout/images/inside_pages/open-house2.jpg" alt="open house" />
			</div>			
			<div class="span6">
				<div class="form_holder">
					<form>
						...
						<fieldset>
							...
							<?php include('../../../buildout/generic/includes/state-list.html'); ?>
							<?php include('../../../buildout/generic/includes/country-list.html'); ?>
						</fieldset>
						<fieldset>
